...
public class SceneManager : MonoBehaviour
{
	...
	public void Init()
	{
		...
		this.goldStorageCapacity = 750;
		this.elixirStorageCapacity = 650;
	}
	...
	{
		this.ClearScene();
		/* load from default scene data or existing deployed objects data */
	...
	public BaseItemScript GetFreeBuilder()
	{
		...
		foreach (KeyValuePair<int, BaseItemScript> entry in _itemInstances)
		{
			/* find already built builder houses */
			if (entry.Value.itemData.id == 3635)
			{
